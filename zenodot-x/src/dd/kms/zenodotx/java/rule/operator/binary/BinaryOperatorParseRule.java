...
public class BinaryOperatorParseRule extends AbstractRule<Void, String, JavaSettings> implements SimpleRule<Void, String, JavaSettings>
{
	...
	public SemanticRule<Void, String, JavaSettings> getSemanticRule() {
		return new AbstractSemanticJavaRule<Void, String>() {
			...
			@Override
			public String evaluate(Void input, String binaryOperator, JavaSettings settings) throws SemanticException, EvaluationException {
