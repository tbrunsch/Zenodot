...
class ParserSettingsImpl implements ParserSettings
{
	...
	ParserSettingsImpl(Set<ClassInfo> importedClasses, Set<String> importedPackageNames, List<Variable> variables, AccessLevel minimumAccessLevel, boolean enableDynamicTyping, ObjectTreeNode customHierarchyRoot, ParserLogger logger) {
