package dd.kms.zenodot.framework.operators;
...
public enum BinaryOperator
{
	...
	public static final int	MAX_BINARY_OPERATOR_PRECEDENCE_LEVEL	= Arrays.stream(values()).mapToInt(BinaryOperator::getPrecedenceLevel).max().getAsInt();
