...
public class ParserSettingsBuilderImpl implements ParserSettingsBuilder
{
	...
	private List<ExtensionMethodDescription>	extensionMethodDescriptions;
	...
	public ParserSettingsBuilderImpl() {
		...
		extensionMethodDescriptions = ImmutableList.of();
	...
	ParserSettingsBuilderImpl(ParserSettings settings) {
		...
		extensionMethodDescriptions = ImmutableList.copyOf(settings.getExtensionMethodDescriptions());
	...
	@Override
	public ParserSettingsBuilder extensionMethodDescriptions(List<ExtensionMethodDescription> extensionMethodDescriptions) {
		this.extensionMethodDescriptions = ImmutableList.copyOf(extensionMethodDescriptions);
		return this;
	}
	...
	public ParserSettings build() {
		return new ParserSettingsImpl(completionMode, importedClasses, importedPackages, minimumAccessModifier, evaluationMode, considerAllClassesForClassCompletions, parserExtensions, extensionMethodDescriptions, logger);
	}
}
