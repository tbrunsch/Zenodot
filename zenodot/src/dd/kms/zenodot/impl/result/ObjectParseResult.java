...
public abstract class ObjectParseResult implements ParseResult
{
	...
	protected abstract ObjectInfo doEvaluate(ObjectInfo thisInfo, ObjectInfo context, VariablesImpl variables) throws Exception;
	...
	public final ObjectInfo evaluate(ObjectInfo thisInfo, ObjectInfo context, VariablesImpl variables) throws ParseException {
		try {
