...
{
	public static CompletionSuggestion classSuggestions(ClassInfo classInfo, int insertionBegin, int insertionEnd, boolean unqualifiedSuggestion) {
		return new CompletionSuggestionClassImpl(classInfo, insertionBegin, insertionEnd, unqualifiedSuggestion);
	}
