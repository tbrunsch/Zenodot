 ...
 * {@link dd.kms.zenodot.api.settings.ParserSettings}.
 */
public interface ParserLogger
{
	 ...
	 * <br/>
	 * See the implementation of {@link ParserConsoleLogger#doStop()} for further information and
	 * check the unit tests to see how this feature can be used automatically.
	 */
