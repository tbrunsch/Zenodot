...
public class IntegerLiteralTest extends EvaluationTest
{
	...
	public static Collection<Object> getTestData() {
		...
		testBuilder
			.addTestWithError("getByte(123)", SemanticException.class)
			.addTestWithError("getShort(1000)", SemanticException.class)
			.addTestWithError("getInt(5000000000)", SemanticException.class);
