...
public class DirectoryCompletionsImpl implements DirectoryCompletions
{
	...
	private void configureSimpleFileConstructor(ParserSettingsBuilder parserSettingsBuilder) throws NoSuchMethodException {
		...
		CompletionProvider completionProvider = new AbsoluteFileDirectoryCompletionProvider(fileDirectoryStructure);
	...
	private void configureFileConstructorRelativeToParentPath(ParserSettingsBuilder parserSettingsBuilder) throws NoSuchMethodException {
		...
		CompletionProvider completionProviderParameter0 = new AbsoluteFileDirectoryCompletionProvider(fileDirectoryStructure);
		CompletionProvider completionProviderParameter1 = new AbstractRelativeFileDirectoryCompletionProvider(fileDirectoryStructure) {
			@Override
			@Nullable
	...
	private void configurePathCreationViaPaths(ParserSettingsBuilder parserSettingsBuilder) throws NoSuchMethodException {
		...
		CompletionProvider completionProviderParameter0 = new AbsolutePathDirectoryCompletionProvider(pathDirectoryStructure, AbstractPathDirectoryCompletionProvider::getDefaultFileSystem);
		CompletionProvider completionProviderParameter1 = new AbstractRelativePathDirectoryCompletionProvider(pathDirectoryStructure, AbstractPathDirectoryCompletionProvider::getDefaultFileSystem) {
			@Override
	...
	private void configurePathCreationViaFileSystem(ParserSettingsBuilder parserSettingsBuilder) throws NoSuchMethodException {
		...
		CompletionProvider completionProviderParameter0 = new AbsolutePathDirectoryCompletionProvider(pathDirectoryStructure, AbstractPathDirectoryCompletionProvider::getCallerFileSystem);
		CompletionProvider completionProviderParameter1 = new AbstractRelativePathDirectoryCompletionProvider(pathDirectoryStructure, AbstractPathDirectoryCompletionProvider::getCallerFileSystem) {
			@Override
			protected Path getRootFile(CallerContext callerContext) throws IOException {
				String rootFilePath = callerContext.getParameter(0, String.class, "parent path");
	...
	private void configurePathChildResolution(ParserSettingsBuilder parserSettingsBuilder) throws NoSuchMethodException {
		...
		CompletionProvider completionProviderParameter0 = new AbstractRelativePathDirectoryCompletionProvider(pathDirectoryStructure, AbstractPathDirectoryCompletionProvider::getCallerFileSystem) {
			@Override
	...
	private void configureURICreation1String(ParserSettingsBuilder parserSettingsBuilder) throws NoSuchMethodException {
		...
		CompletionProvider completionProviderParameter0 = new AbstractURIDirectoryCompletionProvider(pathDirectoryStructure) {
			@Nullable
			@Override
	...
	private void configureURICreation3Strings(ParserSettingsBuilder parserSettingsBuilder) throws NoSuchMethodException {
		...
		CompletionProvider completionProviderParameter1 = new AbstractURIDirectoryCompletionProvider(pathDirectoryStructure) {
			@Override
			protected URI doGetParent(@Nullable String parentPath, CallerContext callerContext) throws Exception {
	...
	private void configureURICreation4Strings(ParserSettingsBuilder parserSettingsBuilder) throws NoSuchMethodException {
		...
		CompletionProvider completionProviderParameter2 = new AbstractURIDirectoryCompletionProvider(pathDirectoryStructure) {
			@Override
			protected URI doGetParent(@Nullable String parentPath, CallerContext callerContext) throws Exception {
				String scheme = callerContext.getParameter(0, String.class, "scheme");
	...
	private void configureURICreation6Strings1Int(ParserSettingsBuilder parserSettingsBuilder) throws NoSuchMethodException {
		...
		CompletionProvider completionProviderParameter4 = new AbstractURIDirectoryCompletionProvider(pathDirectoryStructure) {
			@Override
			protected URI doGetParent(@Nullable String parentPath, CallerContext callerContext) throws Exception {
				String scheme = callerContext.getParameter(0, String.class, "scheme");
